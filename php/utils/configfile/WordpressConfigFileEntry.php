...
/**
 * Writes an key-value-pair into a Wordpress-Config-File.
 */
class WordpressConfigFileEntry extends ConfigFileEntry
{
    ...
    public function __construct($actionParameters, $sectionOptions, $moduleOptions)
    {
        ...
        $configFile = $moduleOptions["ConfigurationFile"];
    ...
    {
        if (parent::run())
            WordpressConfigParser::getInstance()->setProperty(parent::getKey(), parent::getValue());
    }
    ...
    {
        return WordpressConfigParser::getInstance()->getProperty($key);
    }
