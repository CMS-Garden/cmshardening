...
use php\vendor\TYPO3\GeneralUtility;
use php\vendor\TYPO3\ArrayUtility;
use php\vendor\TYPO3\OpcodeCacheService;
...
class ConfigurationManager
{
    ...
    {
        return PATH_typo3conf . $this->localConfigurationFile;
    }
    ...
    {
        return PATH_typo3conf . $this->additionalConfigurationFile;
    }
    ...
    {
        return PATH_typo3conf . $this->additionalFactoryConfigurationFile;
    }
    ...
    {
        $result = false;
        if (true || $this->isValidLocalConfigurationPath($path)) { //Workaround to not include DefaultConfiguration.php and string of other classes 
    ...
    public function writeAdditionalConfiguration(array $additionalConfigurationLines)
    {
        return GeneralUtility::writeFile(
            PATH_typo3conf . $this->additionalConfigurationFile,
            '<?php' . LF .
